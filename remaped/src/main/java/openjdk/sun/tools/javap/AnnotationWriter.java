...
import openjdk.sun.tools.classfile.Annotation;
import openjdk.sun.tools.classfile.Annotation.Annotation_element_value;
import openjdk.sun.tools.classfile.Annotation.Array_element_value;
import openjdk.sun.tools.classfile.Annotation.Class_element_value;
import openjdk.sun.tools.classfile.Annotation.Enum_element_value;
import openjdk.sun.tools.classfile.Annotation.Primitive_element_value;
...
public class AnnotationWriter extends BasicWriter {
  static AnnotationWriter instance(Context context) {
    ...
    if (instance == null) instance = new AnnotationWriter(context);
    return instance;
  }
